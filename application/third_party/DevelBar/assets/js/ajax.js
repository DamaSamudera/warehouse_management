CIjs = function () {
    ...
    var j, a = function (a, b) {
        ...
        if (e) {
            ...
            var i = document.createElement("td"), j = document.createElement("span");
        ...
        var b = d[a];
        f--;
        // var c = b.DOMNode, h = c.children[0], i = c.children[1], j = i.children[0], k = c.children[3], l = c.children[4];
        ...
        //     m.setAttribute("href", cidvl_siteurl + "develbarprofiler/profil/" + b.profiler), m.setAttribute("target", "_blank"), m.textContent = "profiler", l.appendChild(m);
        // }
        g()
    };
    if (j = "addEventListener" in document.createElement("div") ? function (a, b, c) {
        ...
        window.fetch = function () {
            var a = l.apply(this, arguments), b = arguments[0], c = arguments[1];
            "[object Request]" === Object.prototype.toString.call(arguments[0]) && (b = arguments[0].url, c = {
            ...
            var g = {error: !1, url: b, method: f, type: "fetch", start: new Date}, j = d.push(g) - 1;
    ...
    if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
        var m = XMLHttpRequest.prototype.open, n = 0;
        XMLHttpRequest.prototype.open = function (a, b, c, e, f) {
            var g = this, j = {error: !1, url: b, method: a, profiler: "", start: new Date};
    ...
    return {hasClass: a, removeClass: b, addClass: c, addEventListener: j, renderAjaxRequests: g}
