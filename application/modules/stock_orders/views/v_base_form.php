    ...
    <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
        ...
        <div class="inner">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Stock Order</a></li>
...
<div class="container-fluid padding-25 sm-padding-10">
    <div class="card-block">
        <form action="<?= base_url('stock_orders/process'); ?>" method="POST" id="form_input" onsubmit="return false;">
                        ...
                        <div class="row m-t-20">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="card-header ">
                                    <div class="card-title">Products O</div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="card-block m-t-20">
                                    <?php $this->load->view('cv_product_order'); ?>
