    ...
    <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
        <div class="inner">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Draft Sales</li>
            </ol>
            <!-- END BREADCRUMB -->
        </div>
    </div>
...
<div class="container-fluid padding-25 sm-padding-10">
    <div class="row">
        <div class="col-md-12">
            <?php $this->load->view('cv_table_draft'); ?>
        </div>
    </div>
</div>
<!-- MODAL STICK UP  -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-default" id="delete-one" role="form" action="<?= base_url('sales_draft/delete_single')?>">
                    <div class="row">
                        <div class="col-sm-8">
