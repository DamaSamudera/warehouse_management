<script type="text/javascript">
    ...
    var initTableWithSearch = function(status) {
        ...
        var settings = {
            ...
            "iDisplayLength": 5,
            "ajax": "<?= base_url( 'employees/get_data/'); ?>" + status,
            "columns": [
                { "data": null },
                {   "data": "code",
            ...
            },
                {
                    ...
                    "render": function ( data, type, row, meta ) {
                        return '<span style="margin-right: 10px">' +
                            ...
                            '</span><span style="margin-right: 10px"><span><a class="text-success btn_action_form" data-status="edit" data-id="'+data.id+'" href="<?= base_url("employees/action_form/"); ?>'+data.id+'"><i class="fa fa-edit"></i></a></span>';
                    }
                } ]
        };
