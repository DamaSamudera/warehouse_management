...
<div class="container-fluid padding-25 sm-padding-10">
    <div class="row">
        <?= $this->session->userdata('message_status');?>
        <div class="col-md-12">
            <div class="card card-transparent">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="fade1">
                        <?php
                        $data['status'] = "active";
                        $this->load->view('cv_table_customer', $data);
                        ?>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-default" id="delete-one" role="form" action="<?= base_url('customers/delete_single')?>">
                    <div class="row">
                        <div class="col-sm-8">
