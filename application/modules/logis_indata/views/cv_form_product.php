        ...
        <div class="pull-right">
            <div class="col-xs-12">
                <div class="btn-group m-b-5 btn-lg">
                    <a href="<?= base_url('logis_indata/product/action_form'); ?>" class="btn btn-success">Tambah Barang</a>
                    <button data-toggle="tooltip" type="button" data-status="process" class="btn btn-success process" type="submit"
