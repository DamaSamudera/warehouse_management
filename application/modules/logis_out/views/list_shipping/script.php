<script type="text/javascript">
    ...
    var initTableWithSearch = function () {
        ...
        var settings = {
            ...
            "iDisplayLength": 5,
            "ajax": "<?= base_url('logis_out/services/my_shipping'); ?>",
            "columns": [
                {"data": 'code'},
                {"data": 'modified'},
                {"data": 'fro_name'},
                    ...
                    "render": function (data, type, row, meta) {
                        ...
                        return '<span style="margin-right: 10px">' +
                            '<a data-toggle="modal" class="text-danger btn-delete" data-id="' + data.id + '"> <i class="pg-trash_line"> </i></a>' +
                             '</span><span style="margin-right: 10px"><span><a class="text-success btn_action_form" data-status="edit" data-id="' + data.id + '" href="<?= base_url("logis_out/approve/"); ?>' + data.id + '"><i class="fa fa-check"></i></a></span>' ;
                        }else if(data.status == "Approve"){
                            return '<span style="margin-right: 10px">'+ 
                            '<a class="text-success details-control" data-id="'+data.id+'" href="#"> <i class="fa fa-eye"> </i></a></span>' ;
                        } else{
                            return '<span style="margin-right: 10px">';
                        }
                    }
