            ...
            <div class="card-block no-padding">
                <div id="card-circular-minimal" class="card card-default">
                    <div class="card-header  ">
                        <div class="card-title">Laporan Rekap Surat Jalan</div>
                            ...
                            <form id="form-work" action="" method="get" class="form-horizontal" role="form" autocomplete="off">
                              ...
                              <div class="form-group row">
                                  <div class="col-md-4 radio radio-success">
                                    ...
                                    <label for="destination">Tujuan Shipping</label>
                                  </div>
                                  <div class="col-md-8 p-l-0">
                                      <input type="text" name="store" id="store" class="form-control" placeholder="Type store name">
                                    </div>
                              </div>
                              <div class="form-group row">
            ...
            <div class="invoice padding-50 sm-padding-10 ">
                <div>
                    ...
                    <div class="pull-right sm-m-t-20">
                        <h5 class="font-montserrat all-caps bold"><strong>Rekap Surat Jalan</strong></h5>
                    ...
                    <table class="table m-t-50">
                        ...
                        <?php foreach ($logis_out as $detail): ?>
                            <tr>
                                ...
                                <td class="text-center"><?= $detail->des_name ?></td>
                                <td class="text-center"><?= $detail->fro_name ?></td>
