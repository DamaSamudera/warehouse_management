    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="text-left text-white p-b-5"><?= $this->lang->line('login_h_title'); ?></h5>
            </div>
            <div class="modal-body">
                <form action="<?= base_url("login/send_help"); ?>" method="post">
                    ...
                    <button class="m-t-10 col-md-12 btn font-montserrat text-black bold btn-warning">K I R I M</button>
                </form>
            </div>
