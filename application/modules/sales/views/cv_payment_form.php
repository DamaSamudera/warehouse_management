<div class="col-md-12 col-cart" style="padding: 0px !important;">
    <div class="card card-default">
        <div class="card-block">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group form-group-default">
                            <label>Nominal</label>
                            <input type="text" id="cash" data-a-sign="Rp " data-a-dec="," name="nominal"
            ...
            <div class="text-center">
                <button class="process btn btn-block btn-warning btn-process btn-lg bold process"
                        value="complete" name="status" id="complete" data-status="complete"><h5>
                        <span class="font-montserrat bold">P R O C E S S</span></h5></button>
            </div>
        </div>
    </div>
</div>