            ...
            <tr>
                <td class="v-align-middle">
                    <div class="text-center">
                        <a data-toggle="close" class="card-close remove_cart" href="#" id="<?= $item["rowid"] ?>"><i class="card-icon card-icon-close"></i></a>
                ...
                <td class="v-align-middle">
                    <input type="text" class="form-control update_cart" value="<?= $item["disc"] ?>" name="disc[]" data-field="disc" data-id="<?= $item["rowid"] ?>"/>
                </td>
                <td class="v-align-middle">
