...
class Suppliers extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('m_suppliers', 'main_model');
    }
    ...
    {
        if ($id) {
            $this->data['supplier'] = $this->main_model->get($id);
        } else {
            $this->data['supplier'] = $this->main_model->get_new_data();
        }
    ...
    {
        $data_post = $this->main_model->array_from_post(array('code','name','contact_name','phone','fax','handphone','email','address','description','is_active'));
