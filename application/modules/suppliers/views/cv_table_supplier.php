<form method="post" id="form_<?= $status ?>" class="form-delete" action="<?= base_url('suppliers/delete_selected'); ?>">
    <div class="card card-transparent">
        <div class="card-header ">
            <div class="card-title">
                <a class="btn btn-complete btn-cons btn-animated from-top pg pg-plus_circle pull-right btn_action_form text-white" data-status="add" style="text-transform: capitalize;" href="<?= base_url('suppliers/action_form'); ?>"><span>Add New Supplier</span></a>
