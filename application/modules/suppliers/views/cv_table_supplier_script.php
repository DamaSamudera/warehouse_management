<script type="text/javascript">
    ...
    var initTableWithSearch = function(status) {
        ...
        var settings = {
            ...
            "iDisplayLength": 5,
            "ajax": "<?= base_url( 'suppliers/get_data/'); ?>" + status,
            "columns": [
                { "data": null },
                {   "data": "code",
            ...
            'columnDefs': [{
                ...
                'render': function (data, type, full, meta){
                    return '<div class="checkbox text-center"><input id="supplier_' + data.id + '" type="checkbox" name="id[]" value="' + data.id + '"><label class="no-padding no-margin" for="supplier_' + data.id + '"></label></div>';
                }
            },
                {
                    "targets": 7,
                    ...
                    "render": function ( data, type, row, meta ) {
                        return '<span style="margin-right: 10px">' +
                            ...
                            '</span><span style="margin-right: 10px"><span><a class="text-success btn_action_form" data-status="edit" data-id="'+data.id+'" href="<?= base_url("suppliers/action_form/"); ?>'+data.id+'"><i class="fa fa-edit"></i></a></span>';
                    }
                } ]
        };
