...
class Store extends MY_Controller
{
    ...
    public function action_form($id = NULL){
        if($id){
            $this->data['store'] = $this->main_model->get($id);
        }else{
            $this->data['store'] = $this->main_model->get_new_data();
        }
    ...
    {
        $data_post = $this->main_model->array_from_post(array('code','name','email','phone','fax','area','address','is_active','is_warehouse'));
