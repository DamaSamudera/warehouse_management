            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group form-group-default">
                        ...
                        <input id='field-code' class='numeric text-black form-control' name='barcode' type='text' value="<?= $product->barcode ?>"
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group form-group-default typehead">
                        ...
                        <input id='supplier' class='form-control' name='supplier_id' type='text' value="<?= $product->n_supplier_id ?>"
                               maxlength='45'>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group form-group-default typehead">
                        ...
                        <input id='category' class='form-control typehead' name='category_id' type='text' value="<?= $product->product_id_category ?>"
                               maxlength='45'>
                    </div>
                </div>
            </div>
