<script type="text/javascript">
    ...
    var initTableWithSearch = function () {
        ...
        var settings = {
            ...
            "iDisplayLength": 5,
            "ajax": "<?= base_url('logis_in/services/all_logis_in'); ?>",
            "columns": [
                {"data": 'code'},
                {"data": 'created'},
                {"data": null},
            ...
            'columnDefs': [
                ...
                },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        if(data.status == "Pending" || data.status == "Repeat"){
                            ...
                            return '<span style="margin-right: 10px">' +
                                '<a data-toggle="modal" class="text-danger btn-delete" data-id="' + data.id + '"><i class="pg-trash_line"></i></a>' +
                                '<span style="margin-right: 10px"><a class="text-primary details-control" data-id="\'+data.id+\'" href="#"> <i class="fa fa-eye"></i></a></span>' +
                                '<span><a class="text-success btn_action_form" data-status="edit" data-id="\' + data.id + \'" href="<?= base_url("logis_in/surat_jalan/"); ?>' + data.id + '"><i class="fa fa-file-text-o"></i></a></span>';
                        } else{
                            return '<span style="margin-right: 10px">';
                        }
                    }
    ...
    var _format = function (d) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // $('.total').html('<tr><td colspan="5" class="text-right">Total Qty</td><td>'+totalqty+'</td></tr>');
